...
const translations = {
  en: {
    ...
    'hero.title.highlight': 'General Notary',
    'hero.title.end': '& Signing Services',
    'hero.description': 'Licensed, bonded, and insured notary serving Perth Amboy and all of New Jersey. Visit our office or use Remote Online Notarization from anywhere. Same-day appointments and bilingual service available.',
    'hero.feature1': 'NJ Licensed & $50K Insured',
    'hero.feature2': 'Office & Remote Services',
    ...
    'services.mobile.title': 'General Notary',
    'services.mobile.description': 'Professional in-office notary services at our Perth Amboy location.',
    'services.mobile.feature1': 'Convenient office location',
    ...
    'services.mobile.price': '$25',
    'services.mobile.includes': 'Includes: Document review, notarization, and certificate completion. Additional documents: $15 each.',
    ...
    'services.fingerprint.feature4': 'License Applications',
     'services.fingerprint.price': 'TBD',
    ...
    'services.buy_now': 'Book Now',
    'services.learn': 'Learn More',
    'services.popular': 'Most Popular',
    'services.areas.title': 'Our Location',
    'services.areas.description': 'Visit our office or use Remote Online Notarization from anywhere:',
    'services.areas.scotch_plains': 'Office: 298 Smith Street',
    'services.areas.perth_amboy': 'Perth Amboy, NJ 08861',
    'services.areas.new_brunswick': 'RON: Available Nationwide',
    'services.areas.piscataway': 'Easy Parking Available',
    'services.areas.plainfield': 'Wheelchair Accessible',
    'services.areas.south_amboy': 'Public Transit Nearby',
    'services.areas.availability': 'In-Office & Remote Services',
    ...
    'about.mobile.title': 'Flexible Options',
    'about.mobile.description': 'Visit our Perth Amboy office or use Remote Online Notarization from anywhere.',
    ...
    'faqs.general.q4.answer': 'We operate Monday through Sunday, 9AM to 9PM, by appointment only. We offer flexible scheduling to accommodate your busy schedule, including evening and weekend appointments.',
    
    'faqs.mobile.title': 'In-Office & Remote Services',
    'faqs.mobile.q1.question': 'Where is your office located?',
    'faqs.mobile.q1.answer': 'Our office is located at 298 Smith Street, Perth Amboy, NJ 08861. We offer convenient parking and are accessible by public transit.',
    ...
    'faqs.mobile.q3.answer': 'Yes! We typically can schedule same-day appointments with 2-4 hours notice. For urgent requests, please call us directly at (908) 514-8180.',
    ...
    'contact.subtitle': 'Contact us today to schedule your notary appointment or get answers to your questions.',
     ...
     'contact.info.location.address': '298 Smith Street, Perth Amboy, NJ 08861',
     'contact.info.location.description': 'In-office and remote notarization available',
    ...
    'contact.info.hours.schedule': 'Mon-Sun: 9AM-9PM',
    ...
    'contact.form.service.mobile': 'General Notary',
    ...
    'contact.form.timing.flexible': 'Flexible Timing',
     ...
     'contact.form.message_placeholder': 'Please provide details about your notary needs, number of documents, preferred appointment time, or any special requirements...',
    ...
    'footer.business_hours': 'Mon–Sun: 9AM-9PM',
    'footer.phone': '(908) 514-8180',
    'footer.email': 'info@notaryandsignings.com',
    'footer.address1': '298 Smith Street',
    'footer.address2': 'Perth Amboy, NJ 08861',
    ...
    'terms.services.mobile': 'In-office notary services at our Perth Amboy location',
    ...
    'terms.fees.mobile': 'In-office notary services: $25 per notarization',
  ...
  es: {
    ...
    'hero.title': 'El Notario General',
    'hero.title.highlight': 'Más Confiable',
    'hero.title.end': 'de Nueva Jersey',
    'hero.description': 'Notario licenciado, garantizado y asegurado sirviendo Perth Amboy y todo Nueva Jersey. Visite nuestra oficina o use Notarización Remota en Línea desde cualquier lugar. Citas el mismo día y servicio bilingüe disponible.',
    'hero.feature1': 'Licenciado en NJ y Asegurado $50K',
    'hero.feature2': 'Servicios en Oficina y Remotos',
    'hero.feature3': 'Servicio Bilingüe (Inglés/Español)',
    'hero.feature4': 'Citas el Mismo Día Disponibles',
    ...
    'services.mobile.title': 'Notario General',
    'services.mobile.description': 'Servicios notariales profesionales en nuestra oficina de Perth Amboy.',
    'services.mobile.feature1': 'Ubicación conveniente',
    'services.mobile.feature2': 'Citas el mismo día disponibles',
    'services.mobile.feature3': 'Múltiples documentos por visita',
    'services.mobile.feature4': 'Servicio bilingüe (EN/ES)',
    'services.mobile.price': '$25',
    ...
    'services.buy_now': 'Reservar Ahora',
    'services.learn': 'Más Información',
    'services.popular': 'Más Popular',
    'services.areas.title': 'Nuestra Ubicación',
    'services.areas.description': 'Visite nuestra oficina o use Notarización Remota en Línea desde cualquier lugar:',
    'services.areas.scotch_plains': 'Oficina: 298 Smith Street',
    'services.areas.perth_amboy': 'Perth Amboy, NJ 08861',
    'services.areas.new_brunswick': 'RON: Disponible a Nivel Nacional',
    'services.areas.piscataway': 'Estacionamiento Disponible',
    'services.areas.plainfield': 'Accesible para Sillas de Ruedas',
    'services.areas.south_amboy': 'Transporte Público Cercano',
    'services.areas.availability': 'Servicios en Oficina y Remotos',
    ...
    'about.mobile.title': 'Opciones Flexibles',
    'about.mobile.description': 'Visite nuestra oficina en Perth Amboy o use Notarización Remota en Línea desde cualquier lugar.',
    ...
    'faqs.general.q4.answer': 'Operamos de lunes a domingo, de 9AM a 9PM, solo con cita previa. Ofrecemos horarios flexibles para acomodar su agenda ocupada, incluyendo citas nocturnas y de fin de semana.',
    
    'faqs.mobile.title': 'Servicios en Oficina y Remotos',
    'faqs.mobile.q1.question': '¿Dónde está ubicada su oficina?',
    'faqs.mobile.q1.answer': 'Nuestra oficina está ubicada en 298 Smith Street, Perth Amboy, NJ 08861. Ofrecemos estacionamiento conveniente y somos accesibles por transporte público.',
    ...
    'faqs.mobile.q3.answer': '¡Sí! Típicamente podemos programar citas el mismo día con 2-4 horas de aviso. Para solicitudes urgentes, por favor llámenos directamente al (908) 514-8180.',
    ...
    'contact.subtitle': 'Contáctanos hoy para programar tu cita notarial u obtener respuestas a tus preguntas.',
     ...
     'contact.info.location.address': '298 Smith Street, Perth Amboy, NJ 08861',
     'contact.info.location.description': 'Servicios en oficina y notarización remota disponibles',
    ...
    'contact.info.hours.schedule': 'Lun-Dom: 9AM-9PM',
    ...
    'contact.form.service.mobile': 'Notario General',
    ...
    'footer.business_hours': 'Lun–Dom: 9AM-9PM',
    'footer.phone': '(908) 514-8180',
    'footer.email': 'info@notaryandsignings.com',
    'footer.address1': '298 Smith Street',
    'footer.address2': 'Perth Amboy, NJ 08861',
